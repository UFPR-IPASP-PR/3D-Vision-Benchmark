...
(Hunyuan3DDiTFlowMatchingPipeline).  Mirrors the structure of no_pool.py but
taps into the three post-diffusion intermediate representations produced by the
VAE decode + volume decode stages.
