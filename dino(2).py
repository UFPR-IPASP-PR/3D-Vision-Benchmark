...
DEFAULT_MODEL = "facebook/dino-vitb8"
...
def main():
    ...
    # Model Config
    parser.add_argument("--model_id", type=str, default=DEFAULT_MODEL, help="Hugging Face model ID (default: facebook/dino-vitb8)")
    ...
    num_registers = get_config_attribute(model, "num_register_tokens", 0)
