#!/usr/bin/env python3
"""
extract_mast3r_features.py

Extract raw ViT encoder features from a MASt3R or DUSt3R model — the feat1/feat2
...
def get_args():
    p = argparse.ArgumentParser(
        description="Extract raw ViT encoder features from MASt3R / DUSt3R.",
    ...
    p.add_argument("--weights",
                   default="naver/DUSt3R_ViTLarge_BaseDecoder_512_dpt", #naver/MASt3R_ViTLarge_BaseDecoder_512_catmlpdpt_metric",
                   help="HuggingFace repo id or local .pth path for the model weights. "
                        "Accepts any AsymmetricMASt3R checkpoint; DUSt3R checkpoints "
                        "can be loaded via AsymmetricCroCo3DStereo.from_pretrained if "
                        "you swap the import.")
