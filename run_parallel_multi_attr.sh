...
#
DINO_V2_PATH="$root/dino_features/dino_cls"
DEPTH_ANYTHING_V1_PATH="$root/depth_anything_features/da_cls"
DEPTH_ANYTHING_V2_PATH="$root/depth_anything_v2/da_cls"
GAMBA_PATH="$root/gamba_features/gamba_feats/"
...
#run_feature "dino_v2_cls"            "$DINO_V2_PATH"
#run_feature "depth_anything_v1_cls"  "$DEPTH_ANYTHING_V1_PATH"
#run_feature "depth_anything_v2_cls"  "$DEPTH_ANYTHING_V2_PATH"
run_feature "gamba_gamba_feats"        "$GAMBA_PATH"    "type"
run_feature "gamba_gamba_feats"        "$GAMBA_PATH"    "make"
run_feature "gamba_gamba_feats"        "$GAMBA_PATH"    "model"
