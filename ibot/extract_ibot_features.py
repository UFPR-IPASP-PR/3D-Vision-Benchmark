...
Adapted from extract_encoder_features.py (DINOv2 / DepthAnything). Mirrors the
same output layout: one .npy file per image, one sub-folder per feature type.
...
────────────────────────
  ...
  Unlike the DINOv2 hub checkpoint used in extract_encoder_features.py, iBOT's
...
# ─────────────────────────────────────────────────────────────────────────────
# 2.  Annotation loaders  (identical to extract_encoder_features.py)
# ─────────────────────────────────────────────────────────────────────────────
...
def preprocess_for_ibot(img_path: str, transform, device: str) -> torch.Tensor:
    ...
    from extract_encoder_features.py's DINOv2 preprocessing, which does an
...
# ─────────────────────────────────────────────────────────────────────────────
# 6.  I/O helpers  (identical to extract_encoder_features.py)
# ─────────────────────────────────────────────────────────────────────────────
